...
export default function ClubHubPage({setPage}) {
    return (
        <div className="page">
            ...
            <h3 className="px-1 pb-1 text-3xl font-bold self-center">TreeHacks 2024</h3>
            <h3 className="px-1 pb-5 text-xl self-center">Team: Natalia Linn, Bryce Kammerzell, Ben Friedman, & Daniel Yang</h3>
