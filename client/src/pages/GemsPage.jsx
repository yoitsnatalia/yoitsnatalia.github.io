    ...
    return (
        <div className="page">
            ...
            <div className="flex justify-center md:mt-5">
                <a className="link mr-5 md:mr-10" href="https://gems16.netlify.app/login" target="_blank">Demo Gems</a>
                <a className="link" href="https://github.com/yoitsnatalia/gems" target="_blank">GitHub Repo</a>
            </div>   
        </div>
    )
}